...

{
    ...
    AssertErrorM()
    {
        ...
        cy.get('#aoLogin > :nth-child(1)').should('include.text','The username/password match has not been found - you have')  
        cy.get('#aoLogin > :nth-child(1)').should('include.text','attempts remaining.')  
    }
